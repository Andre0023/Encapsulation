public class Cargo {
    ...
    public Cargo(Dimensions dimensions, int weight, String deliveryAddress, boolean allowedToFlip, String number, boolean breakable) {
    ...
    public String toString() { //
        return " габариты: " + dimensions + "; \n "
                + "объем груза с учетом габаритов: " + dimensions.volume(2,4,5) + "; \n "
                + "масса: " + weight + "; \n "
